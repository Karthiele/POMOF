...
public class Reporter extends LinkedInWrappers{
	...
	public static void reportStep(String desc, String status) {
        ...
        try {
			FileUtils.copyFile(driver.getScreenshotAs(OutputType.FILE) , new File("D:\\Project\\POM2\\reports\\images\\"+number+".jpg"));
		...
		if(status.toUpperCase().equals("PASS")){
			...
			test.log(LogStatus.FAIL, desc+test.addScreenCapture("D:\\Project\\POM2\\reports\\images\\"+number+".jpg"));
